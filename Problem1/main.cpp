...
int main()
{
    ...
    //Dear Hornof,
    //	I changed the code  from "(int i =1; i<num_machine+1; i++)" to  "(int i =0; i<num_machine; i++)"
    // 	Then, it can be compiled successfully each time.
    // 	Thank you so much for your help  and appreciate you information.
